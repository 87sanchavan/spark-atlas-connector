...
val hdfsFileSystem = FileSystem.get(hdfsConfiguration)
val fsInputStream = hdfsFileSystem.open(new Path("/user/svc-dsat-adsadmin-np/atlas/file.properties"))
val properties = new Properties()
properties.load(fsInputStream)
